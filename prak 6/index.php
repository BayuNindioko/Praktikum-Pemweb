...
<head>
    ...
    <title>Prak 6-Bayu Nindioko-120140088</title>
...
<body>
        ...
        <div class="container">
            <center>
            <h1>Bayu Nindioko - 120140088 Praktikum 6</h1>
            </center>
            ...
            <div class="result">
                ...
                if (isset($_GET['value'])) {
                    ...
                    echo "<p>Bilangan Romawi dari <b>" . $value . "</b> adalah <b>" . intToRoman($value) . "</b></p>";
                }
                ?>
            </div>
        </div>
